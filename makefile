...
INCLUDE = -I/usr/local/Cellar/sdl2/2.0.8/include/SDL2/ -Isrc/vendor -I/usr/local/Cellar/glew/2.1.0/include/ -Ilibs/stb_image/ -I/usr/local/Cellar/freetype/2.9.1/include/freetype2/ -I/usr/local/Cellar/sdl2_mixer/2.0.4/include/SDL2
...
VPATH = libs libs/SDL2-2.0.8 libs/SDL2-2.0.8/include libs/SDL2-2.0.8/docs libs/SDL2-2.0.8/lib libs/SDL2-2.0.8/lib/x64 libs/SDL2-2.0.8/lib/x86 libs/stb_image libs/glew-2.1.0 libs/glew-2.1.0/bin libs/glew-2.1.0/bin/Release libs/glew-2.1.0/bin/Release/x64 libs/glew-2.1.0/bin/Release/Win32 libs/glew-2.1.0/include libs/glew-2.1.0/include/GL libs/glew-2.1.0/lib libs/glew-2.1.0/lib/Release libs/glew-2.1.0/lib/Release/x64 libs/glew-2.1.0/lib/Release/Win32 libs/glew-2.1.0/doc bin/objs bin bin/objs src src/game src/game/combat src/game/combat/enemies src/game/util src/game/menus src/math src/engine src/engine/text src/engine/opengl src/vendor src/vendor/nlohmann
TARGET = bin/game
