...
OBJS = engine.o entity.o indexBuffer.o shader.o texture.o vertexArray.o vertexBuffer.o renderer.o sprite.o state.o combat.o customization.o skillTree.o cutscene.o vec.o
...
skillTree.o: skillTree.cpp skillTree.hpp
